...
public class LinhaDetalheActivity extends AppCompatActivity implements AppBarLayout.OnOffsetChangedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setSubtitle(getString(R.string.ponto_n_, pontoTO.getIdentificador()));
        setTitle(StringHelper.mergeSeparator(" - ", linhaTO.getIdentificadorLinhaFiltrado(), linhaTO.getBandeira()));
